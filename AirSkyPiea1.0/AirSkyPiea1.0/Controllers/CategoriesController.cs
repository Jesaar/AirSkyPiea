    ...
    public class CategoriesController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            return View(await _context.Categories
                .Include(c => c.DestinationCategories)
                .ToListAsync());
        }
        ...
        public async Task<IActionResult> AddOrEdit(int id, Category category)
        {
            if (ModelState.IsValid)
            {
                ...
                return Json(new { isValid = true, html = ModalHelper.RenderRazorViewToString(this, "_ViewAll", _context.Categories.Include(c => c.DestinationCategories).ToList()) });
